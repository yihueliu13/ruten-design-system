...
Single source of truth: `design-system-all.json` (649 tokens + 130 Text Styles).

## Architecture
Single Figma Collection, three tiers: `ref(159) → sys(168) → comp(322)`.
...
- Button icon-color aliases text-color (currentColor pattern)
- Icon vector fill bound to comp/icon/md/color Variable
- iconPosition uses form variant (label/icon-label/label-icon), not Component Property
- Figma paint color binding: use paint.boundVariables, NOT setBoundVariable("fills")
